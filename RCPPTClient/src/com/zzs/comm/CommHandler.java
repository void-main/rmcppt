...
package com.zzs.comm;

import java.io.IOException;
import java.io.OutputStream;
import java.util.ArrayList;

import com.zzs.rcpptclient.MainActivity;
...
public abstract class CommHandler
{
	...
	public final void doWrite(byte[] data)
	{
		...
		catch(IOException ioe)
		{
			...
			handler.obtainMessage(MainActivity.MESSAGE_DISCONNECTED).sendToTarget();
			disconnect();
		}
	}
	...
	private class ConnectThread extends Thread
	{
		...
		public void run()
		{
			try
			{
				...
				sendThread.start();
				handler.obtainMessage(MainActivity.MESSAGE_CONNECTED).sendToTarget();
			}
			catch(IOException ioe)
			{
				connectionStatus = ConnectionStatus.DISCONNECTED;
